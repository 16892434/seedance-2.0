...
- Extended the JSON schema, `project_state_check.py` (six new negative-tested gates), all four example fixtures, the Project State Capsule (SCENE MAP / CURRENT SCENE), and the root sequence invariants for the scene layer. Added eval `scene_layer_caps_extension_chain`.
